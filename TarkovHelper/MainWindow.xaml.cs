    ...
    private void RefreshYandexStatus()
    {
        ...
        TxtYandexStatus.Text = !ready
            ? "Нужны ключ и каталог. В «API-ключ» — секретное значение ключа (показывается один " +
              "раз при создании), в «Каталог» — идентификатор каталога вида b1g… из адреса консоли. " +
              "Идентификаторы, начинающиеся с aje…, сюда не подходят: так выглядят и сам ключ, и " +
              "сервисный аккаунт."
            : !s.UseYandexOcr
