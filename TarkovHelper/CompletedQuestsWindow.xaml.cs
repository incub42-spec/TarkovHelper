...
/// </summary>
public partial class CompletedQuestsWindow : Window
{
    private readonly List<MainWindow.QuestRow> _all;
    private string? _sortProperty;
    private ListSortDirection _sortDirection = ListSortDirection.Ascending;

    internal CompletedQuestsWindow(IEnumerable<MainWindow.QuestRow> completed)
    {
        InitializeComponent();
        _all = completed.ToList();
        Apply();
    }
    ...
    private void OnCompletedChanged(object sender, RoutedEventArgs e)
    {
        ...
        TxtCount.Text = $"квестов: {_all.Count(r => r.IsCompleted)}";
    }
