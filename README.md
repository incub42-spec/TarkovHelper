...
* в поле «Каталог» идёт идентификатор **каталога** (`b1g…`), а не сервисного
  аккаунта (`aje…`): они лежат на соседних страницах консоли и выглядят
  одинаково. Яндекс на путаницу отвечает внятно и сам называет верное
  значение — текст ошибки виден в настройках;
