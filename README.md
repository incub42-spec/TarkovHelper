...
Статус «новое!» означает только, что квест ещё не открывали: он бывает и
доступным, и заблокированным — замок игра пишет в карточке справа, а в строке
списка его не видно. Такой квест точно не сдан, поэтому ошибочная отметка с
него снимается, но доступным он от этого не считается и цепочку по нему не
достраиваем.
...
**Shift+F11 — сверка со списком игры.** С патча 1.1.0 торговец выдаёт задания
не цепочкой, а пачками по два-четыре, привязанными к уровню лояльности, и
невыданные в списке **не показываются вовсе** — даже с галочкой
«Заблокированные». Поэтому отсутствие квеста в списке не всегда значит «сдан»:
проверяйте, что именно сверка отметила, и откатывайте, если ошиблась. Список без галочки «Завершенные» —
...
виден целиком, без прокрутки: если строки доходят до нижнего края кадра,
программа откажется сверять — снизу почти наверняка есть ещё, и отсутствие
квеста в кадре тогда ничего не значит. У Прапора и Механика списки длинные,
их сперва надо пройти с галочкой «Завершенные».

Если в кадре окажется строка, которой нет в базе
(событийные задания, «Выйти с локации»), программа об этом скажет — тогда стоит
проглядеть список отмеченных: там мог оказаться лишний квест. Откат — той же
кнопкой «Откатить сканирование».
