...
* похожих идентификаторов там три, и в запрос идёт только один. В «API-ключ»
  ...
  адреса консоли после `/folders/`. Всё, что начинается с `aje…`, не подходит:
  так выглядят и идентификатор самого ключа, и сервисный аккаунт. Яндекс на
