...
Подсказка держится шесть секунд, но убрать её можно раньше: **навести на неё
курсор или щёлкнуть любой кнопкой мыши**. Ждать, пока она пропадёт сама, не надо.
...
- **Квесты** — список всех квестов с отметкой выполнения (поиск, фильтр) и
  колонкой фракции. У части квестов в игре две версии — для USEC и для BEAR,
